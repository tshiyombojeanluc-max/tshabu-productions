    ...
    <>
      ...
      <MinimalistHero
        ...
        socialLinks={[
          ...
          { icon: <ImageIcon className="h-5 w-5" />, href: "https://www.instagram.com/tshabuproductions", label: "Instagram" },
          { icon: <Video className="h-5 w-5" />, href: "https://www.tiktok.com/@tshabu.production", label: "TikTok" },
        ]}
